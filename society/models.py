...
class Transaction(models.Model):
    ...
    resident    = models.ForeignKey(ResidentProfile, on_delete=models.CASCADE, related_name='transactions')
    due         = models.ForeignKey(MaintenanceDue, on_delete=models.SET_NULL, null=True, blank=True, related_name='transactions')
    booking     = models.ForeignKey(FacilityBooking, on_delete=models.SET_NULL, null=True, blank=True, related_name='transactions')
